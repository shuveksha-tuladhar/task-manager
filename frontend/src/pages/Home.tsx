...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen w-full bg-base-200 px-6">
      <div className="text-center bg-base-100 p-8 rounded-lg shadow-lg max-w-md">
        ...
        <h2 className="text-lg font-normal text-secondary">Stay Organized and Be Productive!</h2>
